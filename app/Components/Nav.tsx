    ...
    >
      ...
      >
        ...
        <ul className="nav-menu hidden lg:flex w-full justify-center items-center gap-14 py-5 relative">
          ...
          <li><Link href="/About" className="active font-[500] hover:text-black transition-colors duration-500">About</Link></li>
          <li><Link href="/Tour" className="active font-[500] hover:text-black transition-colors duration-500">Tour</Link></li>
          ...
          <li><Link href="/Faq" className="active font-[500] hover:text-black transition-colors duration-500">Faq</Link></li>
          <li><Link href="/Blog" className="active font-[500] hover:text-black transition-colors duration-500">Blog</Link></li>
          <li><Link href="/Contact" className="active font-[500] hover:text-black transition-colors duration-500">Contact</Link></li>
        </ul>
